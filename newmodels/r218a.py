...
def run_apex_training():
    ...
    potential_paths = [t_weights, os.path.join("/home/scidev/PycharmProjects/PythonProject/", t_weights)]
    ...
    for epoch in range(1, epochs + 1):
        ...
        attention_signal = 1.0 + (reward_error * 2.5) + (abs(ac["prec_chg"]) * 8.0)
